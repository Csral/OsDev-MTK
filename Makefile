...
./build/isr80h/misc.o: ./src/kernel/isr80h/misc.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/kernel/isr80h/misc.c -o ./build/isr80h/misc.o

./build/isr80h/io.o: ./src/kernel/isr80h/io.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/kernel/isr80h/io.c -o ./build/isr80h/io.o

./build/isr80h/memory.o: ./src/kernel/isr80h/memory.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/kernel/isr80h/memory.c -o ./build/isr80h/memory.o

./build/isr80h/process.o: ./src/kernel/isr80h/process.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/kernel/isr80h/process.c -o ./build/isr80h/process.o
...
./build/keyboard/keyboard.o: ./src/kernel/keyboard/keyboard.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/kernel/keyboard/keyboard.c -o ./build/keyboard/keyboard.o
...
user_programs:
	...
	cd ./programs/cblank && $(MAKE) all
	cd ./programs/shell && $(MAKE) all

user_programs_clean:
	cd ./programs/stdlib && $(MAKE) clean
	cd ./programs/blank && $(MAKE) clean
	cd ./programs/cblank && $(MAKE) clean
	cd ./programs/shell && $(MAKE) clean

copy_user_programs: user_programs
	sudo cp ./programs/blank/blank.elf /mnt/OsDevMnt
	sudo cp ./programs/cblank/cblank.elf /mnt/OsDevMnt
	sudo cp ./programs/shell/shell.elf /mnt/OsDevMnt
